...
*********************************************************************************
* Source Name:  
*   XmvPressureOilDeferredDailyHistValuesQuery.sql
*  
* Purpose:      
*   SQL Query used to retrieve and format XMV Pressure Oil Deferred 
*   Daily historical values for in the range 2017-12-25 thru current 
*   day. 
*
* Data Source:
